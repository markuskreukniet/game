...
// TODO: check createCollisionSystem
// createCollisionSystem, combinedHalfExtent is good naming
    ...
    update(world) {
      ...
      for (const e of world.entities) {
        if (e.type === "block") {
          ...
          if (dxAbs < combinedHalfExtent && dyAbs < combinedHalfExtent) {
            const overlapX = combinedHalfExtent - dxAbs;
            const overlapY = combinedHalfExtent - dyAbs;
